...
if __name__ == "__main__":
    ...
    # load Temperature
    path = "C:\\Users\\Alex Post\\Documents\\0Refinement\\domain\\"
    ...
    from chrest.XML1DFlameReader import ReadFile
    ...
    indRQ, indMT, indBO = [np.nan, np.nan, np.nan];
    ExtinguishTemp = 800;
